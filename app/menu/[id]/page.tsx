...
const styles = {
  ...
  headerSection: { display: 'flex', gap: '25px', alignItems: 'center', marginBottom: '35px' },
  mainImage: { width: '130px', height: '130px', borderRadius: '50%', border: '3px solid #d4af37', objectFit: 'cover' as const },
  titleBox: { flex: 1 },
